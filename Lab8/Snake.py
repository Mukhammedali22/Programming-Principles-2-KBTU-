...
class Timer:
    ...
    def draw(self, time):
        time = font_small.render("time: " + str(time), True, 'black')
...
class Main:
    ...
    def draw_score(self):
        ...
        score = font_small.render("x" + str(score_text), True, "black")
    ...
    def draw_speed(self):
        speed = font_small.render("snake speed: " + str(SNAKE_SPEED) + " b/s", True, "black")
    ...
    def win(self):
        ...
        #pygame.mixer.Sound("sounds\\congratulation.wav").play(0)
